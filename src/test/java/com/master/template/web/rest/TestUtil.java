...
import static co.id.collega.gw.config.JacksonConfiguration.ISO_DATE_OPTIONAL_TIME;
import static co.id.collega.gw.config.JacksonConfiguration.ISO_FIXED_FORMAT;
